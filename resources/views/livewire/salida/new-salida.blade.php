<div>
    ...
    <form class="grid grid-cols-2 gap-3" name="formulario">
        <div class="mb-6">
            ...
            <input type="date" wire:model.defer="salidaArray.fecha" id="fecha" name="fecha"
        ...
        <div class="mb-6">
            ...
            <input type="time" wire:model.defer="salidaArray.hora" id="hora" name="hora"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required>
        </div>
        <div class="mb-6">
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Motivo</label>
            <input type="text" wire:model.defer="salidaArray.motivo" id="motivo" name="motivo"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required>
        </div>
    </form>
